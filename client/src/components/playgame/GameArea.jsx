          ...
          <div className="col-span-3 space-y-3 flex flex-col">
            ...
            <div className="bg-black/30 rounded-lg p-3 border border-gray-700/50">
                  ...
                  {hintData.threePartsMatch && (
                    <div className="mt-2 pt-2 border-t border-gray-700/50">
                      ...
                      <div className="flex gap-1">
                        {/* Part 1 Indicator */}
                        <div className={`flex-1 h-1.5 rounded ${hintData.threePartsMatch.part1Match
                          ? 'bg-green-500'
                          : 'bg-gray-700'
              ...
              <div className="mt-3 pt-3 border-t border-gray-700/50">
                ...
                <div className="w-full h-1.5 bg-gray-700 rounded-full overflow-hidden">
                  <div
                    className={`h-full transition-all duration-300 ${patternBlockCount && currentBlockCount >= patternBlockCount
                      ? 'bg-green-500'
                      : 'bg-blue-500'
                      }`}
                    style={{
            ...
            <div className="bg-black/30 rounded-lg p-3 border border-gray-700/50 flex flex-col gap-2 flex-1">
              ...
              <div className="flex gap-2 mt-auto">
                <button
                  ...
                  className={`flex-1 py-1.5 rounded text-xs font-medium transition-colors border ${needHintDisabled
