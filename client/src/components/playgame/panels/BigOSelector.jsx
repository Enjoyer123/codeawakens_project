 ...
 * @param {Object} props.patternData - Hint data to check if pattern is 100% matched
 */
const BigOSelector = ({ userBigO, onUserBigOChange, patternData }) => {
  const isDisabled = patternData?.patternPercentage !== 100;
