    ...
    <statement name="STACK">
      ...
      <block type="subset_sum_consider" id="consider_item">
        <value name="WARRIOR_INDEX">
          <block type="variables_get" id="index_var_consider">
        ...
        <next>
          ...
          <block type="controls_if" id="base_case_sum_equals_target">
            ...
            <next>
              <!-- Base case: if index >= arr.length, return false (0-based in this project) -->
              <block type="controls_if" id="base_case_index_out_of_bounds">
                  ...
                  <block type="logic_compare" id="index_gte_length">
                    ...
                    <value name="B">
                      <block type="lists_length" id="arr_length">
                        <value name="VALUE">
                          <block type="variables_get" id="arr_var_base_length">
                ...
                <next>
                  ...
                  <block type="subset_sum_include" id="add_warrior_side1">
                    <value name="WARRIOR_INDEX">
                    ...
                    <next>
                      ...
                      <block type="controls_if" id="try_include_item">
                        ...
                        <next>
                          <!-- Try excluding current item: Reset first to show Backtrack -->
                          <block type="subset_sum_reset" id="reset_warrior_mid">
                            <value name="WARRIOR_INDEX">
                              <block type="variables_get" id="index_var_visual_reset">
                                <field name="VAR">index</field>
                              </block>
                            </value>
                            <next>
                              <!-- Then exclude warrior -->
                              <block type="subset_sum_exclude" id="subset_sum_exclude_block">
                                <value name="WARRIOR_INDEX">
