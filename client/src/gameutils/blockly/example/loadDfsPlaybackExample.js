 ...
 * ไม่มี move_along_path block → ใช้ return value + trace แทน
 */
import * as Blockly from "blockly/core";

// DFS Example XML — Pure Logic (ไม่มี visual blocks)
const dfsPlaybackXml = `<xml xmlns="https://developers.google.com/blockly/xml">
  <!-- DFS Function Definition -->
  <block type="procedures_defreturn" id="dfs_function" x="50" y="50">
    <field name="NAME">DFS</field>
    <comment pinned="false" h="80" w="160">DFS algorithm: หาเส้นทางจาก start ไป goal</comment>
...
<value name="LIST">
  ...
  <!-- Main code: เรียก DFS แล้ว return result -->
  <block type="variables_set" id="main_result" x="50" y="600">
    <field name="VAR">result</field>
    <value name="VALUE">
...
/**
 * Load DFS Playback example blocks into Blockly workspace
