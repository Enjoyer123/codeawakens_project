...
const GUIDE_INCLUDE = { level: { select: { level_id: true, level_name: true, category: { select: { category_name: true } } } }, guide_images: { orderBy: { guide_file_id: "asc" } } };
...
export const createGuide = async (data) => prisma.guide.create({ data, include: { level: { select: { level_id: true, level_name: true, category: { select: { category_name: true } } } }, guide_images: true } });
